...
async function onEncrypt() {
  ...
  if (password != confirmation) {
    confirmPassword.setCustomValidity("Veuillez réinitialiser les mots de passe car ils ne correspondent pas entre eux.");
...
function onCopy(id) {
  ...
  alertArea.innerText = `Copié ${output.value.length} caractères`;
